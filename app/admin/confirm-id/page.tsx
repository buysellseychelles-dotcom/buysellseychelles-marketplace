...
export default async function ConfirmIdPage({
  searchParams,
}: {
  ...
  // Defence in depth: the link must carry a valid signature for this submission.
    ...
    return (
      <div className="max-w-md mx-auto px-4 py-10">
        <div className="bg-white border border-gray-100 rounded-2xl p-6 text-center">
          ...
          <p className="text-sm text-gray-500 mb-5">This confirmation link could not be verified. Please use the admin panel instead.</p>
