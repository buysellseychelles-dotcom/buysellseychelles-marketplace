              ...
              <div key={v.id} className="bg-white border border-gray-100 rounded-2xl p-4 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gray-100 overflow-hidden relative shrink-0">
                  {v.profiles?.avatar_url
                    ? <Image src={v.profiles.avatar_url} alt="" fill className="object-cover" unoptimized />
      ...
      {preview && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" onClick={() => setPreview(null)}>
          <div className="relative max-w-sm w-full" onClick={e => e.stopPropagation()}>
            <Image src={preview} alt="ID document" width={400} height={300} className="rounded-xl object-contain w-full" unoptimized />
  ...
  return (
    <div className="bg-white border border-orange-200 rounded-2xl p-4 space-y-3">
      ...
      <button onClick={onPreview}
        ...
        <Image src={v.document_url} alt="ID document" fill className="object-contain" unoptimized />
